...
def number_of_military_branches():
    return 5
print(number_of_days_in_a_week_silicon_or_triangle_sides() + number_of_military_branches())     # error - undefined variable
...
        return 10
    return 7
print(number_of_oceans_or_fingers_or_continents())      # 100
